      ...
      <div className="flex justify-between max-w-7xl mx-auto">
        <div className="relative text-3xl md:hidden">
          ...
          <input
            ...
            ref={sidebarBtn}
          />
          <div className="top-0 z-20 fixed left-[-300px] peer-checked/draft:left-0 bg-gray-800 h-[100vh] w-[250px] transition-all duration-300 p-2">
              ...
              <nav className="w-full">
                <ul className="w-full divide-y divide-zinc-700 felx flex-col list-none m-0 p-0 text-lg">
                  ...
                  <li className="py-4 px-2 flex justify-between items-center">
                    <Link
                      className="px-5 py-2 hover:opacity-80 bg-orange-400 transition-colors rounded-sm transition"
                      href={"/"}
                    >
                      Sing Up
                    </Link>
                  ...
                  <li className="px-2 py-3">
                    <Link
                      href={"/"}
                      className="hover:text-orange-400 w-full pe-32 py-3"
        ...
        <Link href={"/"}>
          <h2 className="text-orange-400 font-bold text-xl "> MOBIUS</h2>
        </Link>
        <ul className="max-md:hidden flex items-center">
          <li>
            <Link
              className="px-4 py-3 hover:text-orange-400 transition-colors"
              href={"/"}
            >
              Home
            </Link>
        ...
        <div className="max-md:hidden">
          <Link
            className="px-5 py-2 hover:text-orange-400 transition-colors"
            href={"/"}
          >
            Wallet
          </Link>
