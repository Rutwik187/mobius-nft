  ...
  return (
    <section className="flex justify-between flex-wrap max-md:flex-col items-center">
      <div className="md:w-2/5 flex flex-col gap-5 items-start justify-center max-md:text-center max-md:items-center mb-5">
        ...
        <button
          className="px-7 py-2 rounded-sm bg-orange-400 hover:opacity-80"
          data-aos="fade-right"
          data-aos-delay="180"
          data-aos-once
        >
      ...
      >
        <div className="flex gap-5 max-md:flex-col items-center">
          <div className="rounded-sm p-px bg-orange-400">
            <div className="bg-gray-800 rounded-[calc(0.125rem-1px)] p-5 hover:bg-opacity-90 flex flex-col gap-5">
          ...
          <div className="rounded-sm p-px bg-orange-400">
            <div className="bg-gray-800 rounded-[calc(0.125rem-1px)] p-5 hover:bg-opacity-80 flex flex-col gap-5">
              <span className="rounded grid place-items-center p-4 bg-white/10 w-16">
                <Image
